...
local palette
if false then
    local colors = kanagawa.setup({ theme = "dragon" })
    theme = colors.theme
    ...
    theme = require("custom.plugins.lualine.colors.kanagawa.theme")
    palette = require("custom.plugins.lualine.colors.kanagawa.palette")
end
