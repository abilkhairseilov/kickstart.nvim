...
local function clock()
	...
	local time = tostring(os.date()):sub(17,27)
...
-- FIXME: Add missing buffer names for current file component
...
local lualineConfig = {
	...
	tabline = {
		lualine_a = {
			...
			{ distro,  section_separators = topSeparators },
			{
				"tabs",
				mode = 1,
...
--- Old config kept for personal preferences
...
---    },
---    opts = function ()
---        return require("custom.plugins.lualine.minim")
